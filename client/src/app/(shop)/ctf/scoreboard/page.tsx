    ...
    const handleFlagSubmit = async () => {
        ...
        try {
            ...
            if (response.data) {
                ...
                setFlagInput("");
                const updatedFlags = flagList.map((flag) => {
                    if (flag.title === response.flag.title) {
                        return { ...flag, collected: true };
                    }
                    return flag;
                });
                setFlagList(updatedFlags);
            }
        } catch (e) {
            console.error(e);
            showMessage("Error", "You have already collected this flag or this flag is not valid.", "error");
        }
